    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Results update automatically as officials enter finish times.
                </p>
              </div>
        ...
        <Card className="border border-slate-200 bg-white/80 backdrop-blur shadow-sm">
          <CardHeader>
            <CardTitle>Podium (Top 3)</CardTitle>
            <p className="text-sm text-muted-foreground">Fastest finishers</p>
          </CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-yellow-50 rounded-lg p-4 shadow-inner">
                <div className="text-3xl mb-1">🥇</div>
                <div className="font-semibold">{top3[0]?.Athlete?.name || "-"}</div>
                <div className="text-sm text-muted-foreground">
                  {top3[0]?.finishTime?.toFixed(2) || "-"} sec
                </div>
              </div>
